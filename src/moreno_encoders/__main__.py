...
def delete_models(model_type: Optional[str] = None):
    ...
    if model_type:
        ...
        if model_path.exists():
            confirmation = input(f"Are you sure you want to delete the model {model_type}? This action cannot be undone. (yes/no): ")
        ...
        confirmation = input("Are you sure you want to delete all models? This action cannot be undone. (yes/no): ")
        if confirmation.lower() == 'yes':
