...
if __name__ == "__main__":
   ...
   # Create a violinplot for each dataset
    for i, dataset in enumerate(datasets):
        ...
        sns.violinplot(x="Representation", y="AUROC", hue="Representation", data=data, 
                    palette="Pastel1", legend=False, ax=axes[i])
    ...
    plt.savefig(result_folder_path / "model_performance" / "datasets_comparison.pdf", bbox_inches='tight')
    plt.close()